...
const Sidebar = ({ 
    ...
    useEffect(() => {
        loadChats();
        // Listen for storage changes to update when chats are added from other tabs
    ...
    // Refresh chats when currentRepoName changes (for ChatInterface)
    useEffect(() => {
        loadChats();
    }, [currentRepoName]);
                        ...
                        <div className="space-y-2">
                            {chats.map((chat, index) => (
                                ...
                                >
                                    ...
                                    {chat.lastUpdated && !showNewChatButton && (
